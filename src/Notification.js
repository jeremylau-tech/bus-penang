...
function Notify() {
  ...
  const sendNotificationToTelegram = async () => {
    ...
    const message = `Your bus will depart soon`;
    
    const url = `https://api.telegram.org/bot7594084296:AAEgO7zcuE9DY1ja_jWMUPqtqoIkXovqn28/sendMessage?chat_id=937541979&text=${message}`;
